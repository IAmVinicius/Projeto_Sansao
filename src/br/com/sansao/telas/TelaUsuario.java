...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    //Criando o método para alterar dados do usuárioo
    ...
    private void limpar() {
        ...
        cboUsuPerfil.setSelectedItem("usuario");
    }
    ...
    private void initComponents() {
        ...
        txtUsuId.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        ...
        txtUsuNome.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N

        txtUsuLogin.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N

        txtUsuSenha.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N

        cboUsuPerfil.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        cboUsuPerfil.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "usuario", "administrador" }));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel6.setText("Fone");

        txtUsuFone.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        ...
        btnUsuCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sansao/icones/Create.png"))); // NOI18N
        ...
        btnUsuUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sansao/icones/48763_file_edit_icon.png"))); // NOI18N
        btnUsuUpdate.setToolTipText("Editar");
        btnUsuUpdate.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnUsuUpdate.setPreferredSize(new java.awt.Dimension(40, 40));
        ...
        btnUsuRead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sansao/icones/Read.png"))); // NOI18N
        ...
        btnUsuDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sansao/icones/Delete.png"))); // NOI18N
        btnUsuDelete.setToolTipText("Excluir");
        btnUsuDelete.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnUsuDelete.setPreferredSize(new java.awt.Dimension(40, 40));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cboUsuPerfil, 0, 139, Short.MAX_VALUE)
